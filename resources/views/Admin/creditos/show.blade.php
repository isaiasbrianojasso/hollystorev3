<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="row blur">
                <div class="col-lg-12">
                    <div class="text-center border card" style="height:150px">
                        <div class="p-4 pb-0 card-body">
                            <h5 class="mb-4">Agregar Creditos a {{$user->name}} </h5>
                            <p class="text-muted"> Aqui puedes agregar creditos a {{$user->name}} que tiene actualmente
                                {{$user->creditos}}
                                creditos
                            </p>
                            <div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 card-title">Creditos Registrados para {{$user->name}} </h5>
                        </div>
                        <div class="card-body">
